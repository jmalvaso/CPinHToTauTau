...
variables_etau= 'etau_mt,jet_1_pt,etau_lep0_pt,etau_lep0_eta,etau_lep0_phi,etau_lep0_ip_sig,etau_lep1_pt,etau_lep1_eta,etau_lep1_phi,etau_lep1_mass,etau_lep1_decayModePNet,etau_lep1_decayMode,etau_mt,etau_mvis,etau_delta_r,etau_pt,puppi_met_pt,puppi_met_phi'

#'mjj,N_jets_pT_30_eta_4_7_Tight,N_jets_pT_20_eta_2_5_Tight,Leading_jet_pt,Subleading_jet_pt,delta_eta_jj'
...
bkg_ewk_2022preEE='wj_incl_madgraph,ww,wz,zz,dy_lep_madgraph,'
